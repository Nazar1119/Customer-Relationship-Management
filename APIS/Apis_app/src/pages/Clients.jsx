...
import { createClient, deleteClient, getClients, getDevices } from '../services/dotnetApi'
...
const Clients = () => {
  ...
  const filteredDevices = devices.filter((device) => {
    ...
    return Number(deviceClientId) === Number(selectedClientId)
  })
              ...
              {filteredDevices.map((device) => (
                <li key={device.id} className="list-row">
                  <div>
                    ...
                    <div className="list-sub">SN: {device.serial || 'n/a'}</div>
                  </div>
