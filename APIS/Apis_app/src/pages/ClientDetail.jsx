...
const ClientDetail = () => {
  ...
  const filteredDevices = devices.filter((d) => {
    const deviceClientId =
      ...
      d.client?.clientId ??
      d.client?.client_id
    if (deviceClientId == null) return false
    return Number(deviceClientId) === Number(clientId)
  })
            ...
            {devices.map((device) => (
              <li key={device.id} className="list-row">
                <div>
                  ...
                  <div className="list-sub">SN: {device.serialNumber || device.serial || 'n/a'}</div>
                  <div className="list-sub">Type: {device.deviceType || device.type || 'n/a'}</div>
